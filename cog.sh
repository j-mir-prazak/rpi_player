...
looping &
PROC1=$!
trap 'echo waitcogs; kill -SIGTERM $PROC1 2>/dev/null; trap SIGINT; break; terminate' SIGTERM
trap 'echo waitcogs; kill -SIGINT $PROC1 2>/dev/null; trap SIGINT; break; terminate' SIGINT
wait
